...
@Configuration
public class SubscriberTwoConfig {
	...
	@Bean
	public MessageListenerAdapter adapterTopic(SubscriberTwo subscriberOne) {
	...
	public SimpleMessageListenerContainer simpleMessageListenerContainer(MessageListenerAdapter messageListenerAdapter)
		...
		simpleMessageListenerContainer.setClientId("SUBSCRIBER TWO");
